...
public class Config {
/*    public static final String POST_URL = "http://tuition.troubleshoot-tech.com/user.php?email=";
    ...
    public static final String FETCH_SETTINGS_INFO_URL = "http://tuition.troubleshoot-tech.com/showsettings.php?email=";
    public static final String FETCH_STUDENT_INFO_URL = "http://tuition.troubleshoot-tech.com/showstudentinfo.php?email=";

    public static final String UPDATE_TEACHER_EDUCATION_INFO = "http://tuition.troubleshoot-tech.com/teacherEducationInfo.php";
    ...
    public static final String UPDATE_STUDENT_ID_CARD_URL = "http://tuition.troubleshoot-tech.com/idcardstudent.php";
    ...
    public static final String FETCH_EDUCATION_INFO_URL = "http://tuition.tutorcenter-bd.com/showteachereducationinfo.php?email=";
    public static final String FETCH_SETTINGS_INFO_URL = "http://tuition.tutorcenter-bd.com/showsettings.php?email=";
    public static final String FETCH_STUDENT_INFO_URL = "http://tuition.tutorcenter-bd.com/showstudentinfo.php?email=";

    public static final String UPDATE_TEACHER_EDUCATION_INFO = "http://tuition.tutorcenter-bd.com/teacherEducationInfo.php";
    public static final String UPDATE_PERSONAL_INFO_URL = "http://tuition.tutorcenter-bd.com/teacherPersonalInfos.php";
    public static final String UPDATE_STUDENT_INFO_URL = "http://tuition.tutorcenter-bd.com/studentInfo.php";
